...
adb root
adb shell "chmod 777 /data/data/org.kde.necessitas.example.WikipediaMobile/files/"
...
REM #adb push C:\Symbian\Carbide\workspace\kiwixqt\WikipediaMobileQt\res\xml\plugins.xml /data/data/org.kde.necessitas.example.WikipediaMobile/files/xml
adb push C:\Symbian\Carbide\workspace\kiwixqt\WikipediaMobileQt\res\xml\plugins.xml /data/data/org.kde.necessitas.example.WikipediaMobile/files
